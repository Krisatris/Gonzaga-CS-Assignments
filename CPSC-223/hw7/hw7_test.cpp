...
// initial merge sort test
TEST(LinkedSortTest, MergeSort) {
  LinkedListCollection<int, string> c;
  c.add(50, "e");
  c.add(10, "a");
  c.add(30, "c");
...
// initial quick sort test
TEST(LinkedSortTest, QuickSort) {
  LinkedListCollection<int, string> c;
  c.add(50, "e");
  c.add(10, "a");
  c.add(30, "c");
...
// large merge sort test (adapted from earlier large sort test)
TEST(LinkedSortTest, LargeMergeSort) {
  LinkedListCollection<int, int> c;
  for(int i = 100; i > 0; --i) {
    c.add(i, i*100);
  }
...
// large quick sort test (adapted from above)
TEST(LinkedSortTest, LargeQuickSort) {
  LinkedListCollection<int, int> c;
  for(int i = 100; i > 0; --i) {
    c.add(i, i*100);
  }
