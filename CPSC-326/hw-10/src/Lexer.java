...
public class Lexer {
  ...
  public Token nextToken() throws MyPLException {
    ...
    else if(resultStr.equals("try")) {
      return new Token(TokenType.TRY, resultStr, line, column - offset);
    }
    else if(resultStr.equals("catch")) {
      return new Token(TokenType.CATCH, resultStr, line, column - offset);
    }
    else if(resultStr.equals("throw")) {
      return new Token(TokenType.THROW, resultStr, line, column - offset);
    }
