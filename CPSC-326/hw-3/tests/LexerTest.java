...
public class LexerTest {
  ...
  @Test
  public void TokensMyPL() throws Exception {
    String s = "x=y>z<=u().v";
    InputStream in = new ByteArrayInputStream(s.getBytes("UTF-8"));
    Lexer lexer = new Lexer(in);
    Token t = lexer.nextToken();
    ...
    assertEquals(3, t.column());
    t = lexer.nextToken();
    assertEquals(TokenType.GREATER_THAN, t.type());
    assertEquals(">", t.lexeme());
    assertEquals(1, t.line());
    ...
    assertEquals(5, t.column());
    t = lexer.nextToken();
    assertEquals(TokenType.LESS_THAN_EQUAL, t.type());
    assertEquals("<=", t.lexeme());
    assertEquals(1, t.line());
    assertEquals(6, t.column());
    t = lexer.nextToken();
    assertEquals(TokenType.ID, t.type());
    assertEquals("u", t.lexeme());
    assertEquals(1, t.line());
