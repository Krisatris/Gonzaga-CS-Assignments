...
public:
  ...
  //
  //----------------------------------------------------------------------
  void kruskal_min_spanning_tree(Graph& spanning_tree) const;
...
private:
  ...
  bool directed_hamiltonian_rec(int v, std::list<int>& path,
                                bool discovered[]) const;

  // helper function for recursiving finding cliques
